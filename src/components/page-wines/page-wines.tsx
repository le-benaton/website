...
export class PageWines {
  ...
  async componentDidRender() {
    const wines = await fetch('https://przhp2ejw9.execute-api.ap-northeast-1.amazonaws.com/dev/group/2362-5951', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer gytuwze7JQTnrDtO2ucFzwqI11l2',
      },
