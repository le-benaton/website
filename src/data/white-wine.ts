...
export const whiteWine: IItem = {
  ...
  data: [
    ...
    { title: '2012 Saint Verin Chateau Vitallis', ja: 'サンヴェラン シャトー ヴィタイユ', price: '5,400' },
    { title: '2012 BOURGOGNE ALIGOTE DUPONT-FAHN', ja: 'ブルゴーニュ アリゴテ デュポン ファン', price: '5,400' },
    { title: '2014 CHABLIS MARCEL SERVIN', ja: 'シャブリ マルセル セルヴァン', price: '5,500' },
    { title: '1999 Bourgogne Chardonnay Guy BOCARD', ja: 'ブルゴーニュ シャルドネ ギー ボーカール', price: '6,000' },
    {
    ...
    { title: '2010 Bourgogne Blanc TOLLOT BEAUT', ja: 'ブルゴーニュ ブラン トロ ボー', price: '6,600' },
    {
      title: '2013 BOURGOGNE CHARDONAY Francois Carillon',
      ja: 'ブルゴーニュ シャルドネ フランソワ カリヨン',
      price: '6,700',
    },
    { title: '2013 BOURGOGNE BLANC BUTTERFIELD', ja: 'ブルゴーニュ ブラン バターフィールド', price: '7,000' },
    {
    ...
    { title: '2002 Chablis JEAN-MARC-BROCARD', ja: 'シャブリ サン クレール ジャン マルク ブロカー', price: '9,200' },
    { title: '2008 Bourgogne Aligote LEROY', ja: 'ブルゴーニュ アリゴテ ルロワ', price: '9,500' },
    {
    ...
    {
      title: '2007 Cote de Nuits Villages CLOS DES LANGRES MONOPOLE DOMAINE D’ ARDHUY',
      ja: 'コート ド ニュイ ヴィラージュ ブラン ダルデュイ',
      price: '11,000',
    },
    { title: '2009 MEURSAEHT BUTTERFIELD', ja: 'ムルソー バター フィールド', price: '11,000' },
    {
      title: '2005 CHASSAGNE MONTRACHET Les CHAUMEES 1er Cru Domaine Vincent et Francois JOUARD',
      ja: 'シャサーニュモンラッシェ レショーメ ドメーヌ ヴァンサン エ フランソワ ジョアール',
      price: '11,500',
    },
    {
    ...
    {
      title: '2003 CHASSAGNE MONTRACHET Les CHAUMEES 1er cru Domaine Vincent et Francois JOUARD',
      ja: 'シャサーニュモンラッシェ レショーメ ドメーヌ ヴァンサン エ フランソワ ジョアール',
      price: '12,000',
    },
    {
      title: '2008 POUILLY FUISSE Vieilles Vignes DOMAINE CORDIER PERE&amp;FILS',
    ...
    { title: '2012 MEURSAEHT BUTTERFIELD', ja: 'ムルソー バター フィールド', price: '12,800' },
    {
      title: '2011 MEURSAULT Vieilles Vignes Domaine Vincent Girardin',
      ja: 'ムルソー V V ヴァンサン ジラルダン',
      price: '14,700',
    },
    { title: '2012 Beaune Aigrots 1er Cru Albert Morot', ja: 'ボーヌ 1er エグロ アルベール モロ', price: '15,100' },
    {
