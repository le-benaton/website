  ...
  data: [
    {
      ...
      body: '兵庫県より神戸市、尼崎市、西宮市、芦屋市に営業時間の短縮の要請が、<br>令和３年１月１２日（火）～２月７日（日）【２７日間】出ることになりました。<br>当店の営業時間も変更となります。<br>ディナー18：00～19：00(L.O)、21：00閉店とさせて頂きます。<br>ご迷惑をお掛け致しますが、ご理解のほどよろしくお願いいたします。',
    },
        {
      title: 'コロナ感染症予防対策',
