...
export const news: IItem = {
  ...
  data: [
    {
      title: '緊急事態宣言発令中につき',
      body: '「緊急事態宣言」のため、令和３年４月２５日（日）から５月１１日（火）まで営業時間が変わります。ディナー17:30～19:00(L.O)、20:00閉店とさせて頂きます。<br>尚、緊急事態宣言中は酒類のご提供を控えさせて頂きます。<br>（ワイン等種類の持ち込みもお断りさせていただきます。）<br>ご迷惑をお掛け致しますが、ご理解のほどよろしくお願いいたします。',
    },
        {
      title: 'コロナ感染症予防対策',
